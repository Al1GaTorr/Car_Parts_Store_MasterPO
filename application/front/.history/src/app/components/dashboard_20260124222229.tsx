  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 pb-24 px-4 transition-colors">
      ...
      >
        ...
        <div className="bg-yellow-50 dark:bg-yellow-950/30 border border-yellow-200 dark:border-yellow-800/30 rounded-xl p-4 flex items-start gap-3 transition-colors">
          <AlertCircle size={20} className="text-yellow-600 dark:text-yellow-400 mt-0.5 flex-shrink-0" />
          <div>
            <div className="text-sm text-yellow-800 dark:text-yellow-200">Oil Level Low</div>
            <div className="text-xs text-yellow-700 dark:text-yellow-300/70 mt-1">
